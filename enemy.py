...
class Boss2(Enemy):
    ...
    def fire_weapon(self, weapon_number):
        if weapon_number == 1:
            ...
            EnemyProjectile(self.game, "rocket1", self.rocket_damage, (self.pos.x + 705, self.pos.y + 188), "green")
        elif weapon_number == 13:  # sprayer
            EnemyProjectile(self.game, "laser", self.laser_damage, (self.pos.x + self.image.get_width() // 2, self.pos.y + 247), "green")
            EnemyProjectile(self.game, "laser", self.laser_damage, (self.pos.x + self.image.get_width() // 2, self.pos.y + 247), "green")
            EnemyProjectile(self.game, "laser", self.laser_damage, (self.pos.x + self.image.get_width() // 2, self.pos.y + 247), "green")
